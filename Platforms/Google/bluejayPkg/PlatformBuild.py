##
# Script to Build Samsung Galaxy S20 5G UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("bluejayPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('bluejay', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder(UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "bluejay", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "bluejayPkg/bluejay.dsc", "Platform Hardcoded")
